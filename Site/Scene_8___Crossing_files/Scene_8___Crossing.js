...
{document.write('<object id="id11" classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" codebase="http://www.apple.com/qtactivex/qtplugin.cab" width="261" height="212" style="height: 212px; left: 186px; position: absolute; top: 356px; width: 261px; z-index: 1; "><param name="src" value="Media/cross.mp4" /><param name="controller" value="true" /><param name="autoplay" value="false" /><param name="scale" value="tofit" /><param name="volume" value="100" /><param name="loop" value="false" /></object>');}
else if(isiPhone)
{document.write('<object id="id11" type="video/quicktime" width="261" height="212" style="height: 212px; left: 186px; position: absolute; top: 356px; width: 261px; z-index: 1; "><param name="src" value="Scene_8___Crossing_files/cross.jpg"/><param name="target" value="myself"/><param name="href" value="../Media/cross.mp4"/><param name="controller" value="true"/><param name="scale" value="tofit"/></object>');}
else
{document.write('<object id="id11" type="video/quicktime" width="261" height="212" data="Media/cross.mp4" style="height: 212px; left: 186px; position: absolute; top: 356px; width: 261px; z-index: 1; "><param name="src" value="Media/cross.mp4"/><param name="controller" value="true"/><param name="autoplay" value="false"/><param name="scale" value="tofit"/><param name="volume" value="100"/><param name="loop" value="false"/></object>');}}
